...
class CarTest implements Cloneable {
    ...
    public Object clone() {
        try {
            CarTest colonedCar = (CarTest)super.clone();
            return colonedCar;
...
public class ObjectClass {
    public static void main(String[] args) {
        ...
        // clone() 사용의 예제.
        CarTest car3 = new CarTest();
        car3.setModelName("아반떼");
        car3.setOwners("홍길동");
        System.out.println("Car3: " + car3.getModelName() + ", " + car3.getOwners());
        CarTest car4 = (CarTest)car3.clone();
        System.out.println("Car3: " + car3.getModelName() + ", " + car3.getOwners());
        System.out.println("Car4: " + car4.getModelName() + ", " + car4.getOwners());
    }
}
